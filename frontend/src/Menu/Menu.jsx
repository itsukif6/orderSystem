  ...
  const onFinish = () => {
    ...
    fetch("http://localhost:5000/menu", //api
      ...
      .then(json => {
        console.log(json);
        if (json === true) {
          window.location.assign("http://localhost:3001/Order");
        } else {
          alert("123.");
        }
      });
        ...
        <div>
          ...
          <div className="broadImg">
            ...
            <div className="img-text">
              ...
              <div className="order-num">
                <button className="plus-minus-button" onClick={onMinus}>-</button>
                <input ref={pushRef} type="text" id="blackTea-order" name="blackTea-order" required minLength="1" maxLength="3" size="1" defaultValue="0" />
                <button className="plus-minus-button" onClick={onPlus}>+</button>
              </div>
            </div>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
